...
public class AccountService {
	 ...
	 * @param amount : amount which must be subtracted from the user account balance
	 * @return true if the balance is greater than or equal to the amount of the transaction
	 */
	...
	/**
	 * subtracts the amount from the user account and adds the amount to the connection account
